				...
				<tbody>
					<c:forEach items="${ data.content }" var="account">
						<tr>
							...
							<td>${ account.email }</td>
							<td><img src="${ account.photo }" /></td>
							<td>${ account.admin == 1 ? "Admin" : "Member" }</td>
							<td>${ account.activated == 0 ? "In-Active" : "Active" }</td>
							<td><a
								href="/Assignment_ph17470/admin/accounts/update/${account.id}"><button
										class="btn btn-primary">Sửa</button></a></td>
							<td><a
								href="/Assignment_ph17470/admin/accounts/delete/${account.id}"><button
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item"><a class="page-link"
						href="/Assignment_ph17470/admin/accounts/index?page=0&size=10">1</a></li>
					<li class="page-item"><a class="page-link"
						href="/Assignment_ph17470/admin/accounts/index?page=1&size=10">2</a></li>
					<li class="page-item"><a class="page-link"
						href="/Assignment_ph17470/admin/accounts/index?page=2&size=10">3</a></li>
					<li class="page-item"><a class="page-link" href="#"
