...
<body>
	...
	<div class="row">
		...
		<h1 style="text-align: center; color: black;">Quản lý Order</h1>
		<div class="row">
			<div class="col-9">
					...
					<tbody>
						<c:forEach items="${ data.content }" var="order">
							<tr>
								...
								<td>${ order.address }</td>
								<td><a
									href="/Assignment_ph17470/admin/orders/update/${order.id}"><button
											class="btn btn-primary">Sửa</button></a></td>
								<td><a
									href="/Assignment_ph17470/admin/orders/delete/${order.id}"><button
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item"><a class="page-link"
						href="/Assignment_ph17470/admin/orders/index?page=0&size=10">1</a></li>
					<li class="page-item"><a class="page-link"
						href="/Assignment_ph17470/admin/orders/index?page=1&size=10">2</a></li>
					<li class="page-item"><a class="page-link"
						href="/Assignment_ph17470/admin/orders/index?page=2&size=10">3</a></li>
					<li class="page-item"><a class="page-link" href="#"
