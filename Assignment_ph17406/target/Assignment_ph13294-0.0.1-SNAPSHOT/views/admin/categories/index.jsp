				...
				<tbody>
					<c:forEach items="${ data.content }" var="category">
						<tr>
							...
							<td>${ category.name }</td>
							<td><a
								href="/Assignment_ph17470/admin/categories/update/${category.id}"><button
										class="btn btn-primary">Sửa</button></a></td>
							<td><a
								href="/Assignment_ph17470/admin/categories/delete/${category.id}"><button
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item"><a class="page-link"
						href="/Assignment_ph17470/admin/categories/index?page=0&size=10">1</a></li>
					<li class="page-item"><a class="page-link"
						href="/Assignment_ph17470/admin/categories/index?page=1&size=10">2</a></li>
					<li class="page-item"><a class="page-link"
						href="/Assignment_ph17470/admin/categories/index?page=2&size=10">3</a></li>
					<li class="page-item"><a class="page-link" href="#"
